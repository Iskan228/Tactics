	...
	#if IS_C99
		#define LLABS(z) (unsigned long long int)((z) < 0 ? -(z) : (z))
	#else
		#define LLABS(z) (unsigned long int)((z) < 0 ? -(z) : (z))
	#endif /* IS_C99 */

	#define ABS(z) (unsigned int)((z) < 0 ? -(z) : (z))
	#define LABS(z) (unsigned long int)((z) < 0 ? -(z) : (z))
	...
	inline void printBool(bool v)
	{
		print(v ? "true" : "false");
	}

	inline void putsBool(bool v)
	{
		puts(v ? "true" : "false");
	}
